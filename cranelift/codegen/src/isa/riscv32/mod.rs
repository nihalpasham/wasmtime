...
impl Riscv32Backend {
    /// Create a new RV32 backend with the given (shared) flags.
...
fn isa_constructor(
    ...
    // This RV32 bit backend currently only supports the RV32I base instruction set.

    // - I: Base Integer Instruction Set
    // - Zicsr: Control and Status Register Instructions
    // - Zifencei: Instruction-Fetch Fence

    // Support for the following standards extensions is in development.
